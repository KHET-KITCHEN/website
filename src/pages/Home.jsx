  ...
  return (
    <Box>
      ...
      >
        ...
        <Box sx={{ flex: '0 0 48%', display: 'flex', flexDirection: 'column', justifyContent: 'center', pl: { xs: 2, sm: 6, md: 10 }, pr: { xs: 1, sm: 2 }, bgcolor: '#e6f5d0', zIndex: 2 }}>
          <motion.div
          ...
          >
            <Typography variant="h2" component="h1" gutterBottom sx={{ color: '#2E7D32', fontWeight: 700, textShadow: '0 2px 8px rgba(0,0,0,0.15)', textAlign: 'left', width: '100%', ml: 0 }}>
              Pure Organic Products
            </Typography>
            <Typography variant="h5" gutterBottom sx={{ color: '#4E342E', textShadow: '0 2px 8px rgba(255,255,255,0.2)', textAlign: 'left', width: '100%', ml: 0 }}>
        ...
        {/* Right: Farm Image */}
        <Box sx={{ flex: '0 0 52%', display: 'flex', alignItems: 'stretch', justifyContent: 'flex-end', position: 'relative', minWidth: 0 }}>
